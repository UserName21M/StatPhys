...
class TitlePage(QWidget):
    def __init__(self, parent=None):
        ...
        subtitle = QLabel("ВМК МГУ — учебная презентация")
        subtitle.setAlignment(Qt.AlignmentFlag.AlignHCenter)
        subtitle.setStyleSheet("font-size: 16px; color: #444;")
        ...
        l2 = QLabel()
        for lbl in (l1, l2):
            lbl.setPixmap(QPixmap())  # Можно добавить эмблемы (assets/logo1.png, logo2.png)
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.authors = AuthorsPage()
        self.presentation = PresentationPage(self.model)
